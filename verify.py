...
#               'ens3_adv_inception_v3','ens4_adv_inception_v3','ens_adv_inception_resnet_v2'] # 9个

model_names=['resnet_v2_152'] # 'ens3_adv_inception_v3'
...
def main(ori_path='./dataset/images/',adv_path='./adv/',output_file='./log.csv'):
    ...
    with open(output_file,'a+',newline='') as f:
        ...
        for model_name in model_names:
            ...
            print('{0} adv_suc:{1:.1f}%'.format(model_name,adv_successrate*100))
...
if __name__=='__main__':
    ...
    parser.add_argument('--adv_path',default='./adv/sfv_v3/') 
