...
checkpoint_paths = {
    ...
    'resnet_v2_101': None,
    'resnet_v2_152': base_path+'/resnet_v2_152.ckpt',     # '/resnet_v2_152/resnet_v2_152.ckpt'
    'resnet_v2_200': None,
    'vgg_16': base_path+'/vgg_16.ckpt',
    'vgg_19': base_path+'/vgg_19.ckpt',
    'adv_inception_v3':base_path+'/adv_inception_v3.ckpt', # '/adv_inception_v3/adv_inception_v3.ckpt'
    'adv_inception_resnet_v2':base_path+'/adv_inception_resnet_v2.ckpt', # '/adv_inception_resnet_v2/adv_inception_resnet_v2.ckpt'
    'ens3_adv_inception_v3':base_path+'/ens3_adv_inception_v3.ckpt', # '/ens3_adv_inception_v3/ens3_adv_inception_v3.ckpt'
    'ens4_adv_inception_v3':base_path+'/ens4_adv_inception_v3.ckpt', # '/ens4_adv_inception_v3/ens4_adv_inception_v3.ckpt'
    'ens_adv_inception_resnet_v2':base_path+'/ens_adv_inception_resnet_v2.ckpt' # '/ens_adv_inception_resnet_v2/ens_adv_inception_resnet_v2.ckpt'
  }
